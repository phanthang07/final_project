...
import kma.com.company.Threads.MiningThread;
import kma.com.company.Threads.PeerClient;
import kma.com.company.Threads.PeerServer;
import kma.com.company.Threads.UI;
...
//            We will create it in separate db for better security and ease of portability.
            Connection walletConnection = DriverManager
                    .getConnection("jdbc:sqlite:D:\\Project\\e-coin\\db\\wallet.db");
...
//          This will create the db tables with columns for the Blockchain.
            Connection blockchainConnection = DriverManager
                    .getConnection("jdbc:sqlite:D:\\Project\\e-coin\\db\\blockchain.db");
